...
Not to be confused with KRL (programming language).
Kinetic Rule Language
...
Event expressions in the select statement declare the conditions under which the rule will be selected.[6]
